...
public abstract class QuestNode_Root_Mission : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		quest3.AddShipJob_Arrive(transportShip, parent, null, null, ShipJobStartMode.Instant, ofEmpire);
		...
		string inSignal4 = QuestGenUtility.HardcodedSignalWithQuestID("shuttle.LeftBehind");
		...
		quest4.SignalPassActivable(action, null, text3, null, null, inSignalDisable);
