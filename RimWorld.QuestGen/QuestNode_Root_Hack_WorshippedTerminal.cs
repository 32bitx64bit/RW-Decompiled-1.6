...
public class QuestNode_Root_Hack_WorshippedTerminal : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		num = Mathf.Max(num, tribalFaction.def.MinPointsToGeneratePawnGroup(PawnGroupKindDefOf.Settlement_RangedOnly));
		...
		int num2 = 25000;
		site.GetComponent<TimedMakeFactionHostile>().SetupTimer(num2, "WorshippedTerminalFactionBecameHostileTimed".Translate(tribalFaction.Named("FACTION")));
