	...
	protected override void RunInt()
	{
		...
		quest.Delay(180, delegate
		{
			...
			if (Rand.Chance(RaidChance) && Find.Storyteller.difficulty.allowViolentQuests && TryFindRandomEnemyFaction(out var faction))
			{
				...
				{
					Quest quest4 = quest;
					MapParent parent2 = map.Parent;
					float min = RaidRewardPoints.min;
					Faction faction2 = faction;
					string customLetterText2 = "MessageAncientSignalHostileDetected".Translate(faction.def.pawnsPlural.CapitalizeFirst(), faction);
					...
					quest4.Raid(parent2, min, faction2, null, null, customLetterText2, null, null, null, null, null, "root", edgeWalkIn, immediateAttack);
