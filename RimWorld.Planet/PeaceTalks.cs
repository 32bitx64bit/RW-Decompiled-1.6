...
public class PeaceTalks : WorldObject
{
	...
	private void Outcome_Disaster(Caravan caravan)
	{
		LongEventHandler.QueueLongEvent(delegate
		{
			...
			TaggedString letterText = GetLetterText("LetterPeaceTalks_Disaster".Translate(base.Faction.def.pawnsPlural.CapitalizeFirst(), base.Faction.NameColored, Mathf.RoundToInt((float)randomInRange)), caravan, playerRelationKind);
