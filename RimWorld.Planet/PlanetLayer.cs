...
{
	public delegate float CalculateAverageTileSize_00015393_0024PostfixBurstDelegate(in NativeArray<int> tileIDToNeighbors_offsets, in NativeArray<PlanetTile> tileIDToNeighbors_values, in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts);

	internal static class CalculateAverageTileSize_00015393_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(CalculateAverageTileSize_00015393_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static CalculateAverageTileSize_00015393_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public delegate float IntGetTileSize_00015395_0024PostfixBurstDelegate(in NativeArray<int> tileIDToNeighbors_offsets, in NativeArray<PlanetTile> tileIDToNeighbors_values, in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts, in PlanetTile tile);

	internal static class IntGetTileSize_00015395_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(IntGetTileSize_00015395_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static IntGetTileSize_00015395_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public delegate void IntGetTileCenter_00015398_0024PostfixBurstDelegate(in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts, int tileID, out Vector3 center);

	internal static class IntGetTileCenter_00015398_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = (nint)BurstCompiler.GetILPPMethodFunctionPointer2(DeferredCompilation, (RuntimeMethodHandle)/*OpCode not supported: LdMemberToken*/, typeof(IntGetTileCenter_00015398_0024PostfixBurstDelegate).TypeHandle);
			}
			P_0 = Pointer;
		}
		...
		static IntGetTileCenter_00015398_0024BurstDirectCall()
		{
			Constructor();
		}
	...
	public void InitializeLayer()
	{
		...
		verts = NativeArrayUtility.GetNativeArrayCopy<Vector3>(tmp_generatedVerts, (Allocator)4, clearMemory: false);
		tileIDToVerts_offsets = NativeArrayUtility.GetNativeArrayCopy(tmp_generatedVertOffsets, (Allocator)4);
	...
	private void Subdivide(bool lastPass)
	{
		...
		for (int count2 = tmp_tris.Count; i < count2; i++)
		{
			...
			Vector3 val = (tmp_verts[triangleIndices.v1] + tmp_verts[triangleIndices.v2] + tmp_verts[triangleIndices.v3]) / 3f;
			tmp_verts.Add(((Vector3)(ref val)).normalized * Radius);
		}
	...
	private bool ShouldDiscardGeneratedTile(List<int> generatedTileVertsList)
	{
		...
		{
			val += tmp_verts[generatedTileVertsList[i]];
		}
		return !MeshUtility.VisibleForWorldgen(val / (float)generatedTileVertsList.Count, Radius, viewCenter, viewAngle);
	}
	...
	private void CalculateTileNeighbors()
	{
		...
		tileIDToNeighbors_offsets = NativeArrayUtility.GetNativeArrayCopy(list2, (Allocator)4);
		tileIDToNeighbors_values = NativeArrayUtility.GetNativeArrayCopy(list3, (Allocator)4);
	}
	...
	{
		return CalculateAverageTileSize_00015393_0024BurstDirectCall.Invoke(in tileIDToNeighbors_offsets, in tileIDToNeighbors_values, in tileIDToVerts_offsets, in verts);
	}
	...
	{
		return IntGetTileSize_00015395_0024BurstDirectCall.Invoke(in tileIDToNeighbors_offsets, in tileIDToNeighbors_values, in tileIDToVerts_offsets, in verts, in tile);
	}
	...
	{
		IntGetTileCenter_00015398_0024BurstDirectCall.Invoke(in tileIDToVerts_offsets, in verts, tileID, out center);
	}
	...
	public Vector2 LongLatOf(int tileID)
	{
		...
		float num2 = Mathf.Asin(tileCenter.y / Radius) * 57.29578f;
	...
	public void GetTileVertices(int tileID, List<Vector3> outVerts)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		PackedListOfLists.GetList<Vector3>(tileIDToVerts_offsets, verts, tileID, outVerts);
	}
	...
	public void GetTileVerticesIndices(int tileID, List<int> outVertsIndices)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		PackedListOfLists.GetListValuesIndices<Vector3>(tileIDToVerts_offsets, verts, tileID, outVertsIndices);
	}
	...
	public int GetTileNeighborCount(int tileID)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		return PackedListOfLists.GetListCount<PlanetTile>(tileIDToNeighbors_offsets, tileIDToNeighbors_values, tileID);
	}
	...
	public int GetMaxTileNeighborCountEver(int tileID)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		return PackedListOfLists.GetListCount<Vector3>(tileIDToVerts_offsets, verts, tileID);
	}
	...
	public bool IsNeighbor(int tileA, int tileB)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		(int start, int end) listIndexes = PackedListOfLists.GetListIndexes<PlanetTile>(tileIDToNeighbors_offsets, tileIDToNeighbors_values, tileA);
	...
	public PlanetTile GetTileNeighbor(int tileID, int adjacentId)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		var (num, num2) = PackedListOfLists.GetListIndexes<PlanetTile>(tileIDToNeighbors_offsets, tileIDToNeighbors_values, tileID);
	...
	protected virtual void RawDataToTiles()
	{
		if (tiles.Count != TilesCount)
		{
			...
			{
				Tile tile = orCreateTileFactoryMethod(new PlanetTile(j, this));
				tiles.Add(tile);
	...
	public bool LineIntersects(Vector3 A, Vector3 B, float radiusFactor = 1f)
	{
		...
		float num = Vector3.Dot(val2, val3) / sqrMagnitude;
		if (num < 0f)
		{
			return false;
		}
		...
		Vector3 val4 = A + val3 * num;
		return Vector3.Distance(val, val4) < Radius * radiusFactor;
	}
	...
	public static float CalculateAverageTileSize_0024BurstManaged(in NativeArray<int> tileIDToNeighbors_offsets, in NativeArray<PlanetTile> tileIDToNeighbors_values, in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts)
	{
		...
		for (int i = 0; i < length; i++)
		{
			...
			(int start, int end) listIndexes = PackedListOfLists.GetListIndexes<PlanetTile>(tileIDToNeighbors_offsets, tileIDToNeighbors_values, i);
			int item = listIndexes.start;
			int item2 = listIndexes.end;
	...
	public static float IntGetTileSize_0024BurstManaged(in NativeArray<int> tileIDToNeighbors_offsets, in NativeArray<PlanetTile> tileIDToNeighbors_values, in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts, in PlanetTile tile)
	{
		...
		for (int i = tileIDToNeighbors_offsets[(int)tile]; i < num3; i++)
		{
	...
	public static void IntGetTileCenter_0024BurstManaged(in NativeArray<int> tileIDToVerts_offsets, in NativeArray<Vector3> verts, int tileID, out Vector3 center)
	{
		...
		(int start, int end) listIndexes = PackedListOfLists.GetListIndexes<Vector3>(tileIDToVerts_offsets, verts, tileID);
		int item = listIndexes.start;
		int item2 = listIndexes.end;
		Vector3 val = Vector3.zero;
		int num = 0;
