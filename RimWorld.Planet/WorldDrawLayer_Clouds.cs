...
public class WorldDrawLayer_Clouds : WorldDrawLayer
{
	...
	public override IEnumerable Regenerate()
	{
		...
		if ((Object)(object)material == (Object)null)
		{
			...
			material.SetVector(ShaderPropertyIDs.Seed, Vector4.op_Implicit(new Vector2(Random.value, Random.value)));
			material.SetFloat(ShaderPropertyIDs.PlanetRadius, planetLayer.Radius);
			material.SetVector(ShaderPropertyIDs.PlanetOrigin, Vector4.op_Implicit(planetLayer.Origin));
			...
			material.SetTexture(ShaderPropertyIDs.NoiseTex, (Texture)(object)noiseTexture);
			material.SetTexture(ShaderPropertyIDs.SunsetColorRamp, (Texture)(object)sunsetColorRamp);
			material.SetTexture(ShaderPropertyIDs.CloudMap, (Texture)(object)cloudTexture);
			set = false;
		}
