...
public class WorldObject : IExposable, ILoadReferenceable, ISelectable
{
	...
	public virtual Material ExpandingMaterial
	{
		get
		{
			...
			if ((Object)(object)expandingMaterial != (Object)null)
			{
				return expandingMaterial;
			}
			MaterialRequest materialRequest = default(MaterialRequest);
			materialRequest.mainTex = (Texture)(object)def.ExpandingIconTexture;
	...
	public virtual Texture2D ExpandingIcon
	{
		get
		{
			...
			if ((Object)(object)def.ExpandingIconTexture != (Object)null)
			{
	...
	public virtual Color ExpandingIconColor => (Color)(((_003F?)def.expandingIconColor) ?? Material.color);
	...
	public virtual void Draw()
	{
		...
		if (!Tile.LayerDef.isSpace && Object.op_Implicit((Object)(object)Material))
		{
			...
			for (j = 0; j < quests.Count; j++)
			{
				...
				if (!quest.hidden && !quest.Historical && !quest.dismissed && quest.QuestLookTargets.Contains(this))
				{
					yield return new Command_Action
					{
						...
						icon = (Texture)(object)ViewQuestCommandTex,
						Order = -1f,
						action = delegate
						{
