...
public class WorldObjectsHolder : IExposable
{
	...
	{
		return CollectionExtensions.GetValueOrDefault<PlanetLayer, List<WorldObject>>((IReadOnlyDictionary<PlanetLayer, List<WorldObject>>)layerWorldObjects, layer, EmptyWorldObjectList);
	}
