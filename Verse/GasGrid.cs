...
public class GasGrid : IExposable
{
	...
	public Vector4 DensitiesAt(IntVec3 cell)
	{
		...
		float num4 = (int)DensityAt(index, GasType.DeadlifeDust);
	...
	private void TryDiffuseGases(IntVec3 cell)
	{
		...
		for (int i = 0; i < cardinalDirections.Count; i++)
		{
			...
			if (false | TryDiffuseIndividualGas(ref gasA, ref gasB) | TryDiffuseIndividualGas(ref gasA2, ref gasB2) | TryDiffuseIndividualGas(ref gasA3, ref gasB3))
			{
