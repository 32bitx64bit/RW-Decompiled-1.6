...
public class HediffSet : IExposable
{
	...
	public bool HasHead
	{
		get
		{
			bool valueOrDefault = cachedHasHead.GetValueOrDefault();
	...
	public bool PreventVacuumBurns
	{
		get
		{
			bool valueOrDefault = cachedPreventVacuumBurns.GetValueOrDefault();
	...
	public bool HasRegeneration
	{
		get
		{
			...
			bool valueOrDefault = cachedHasRegeneration.GetValueOrDefault();
	...
	public bool RemoveRoamMtb
	{
		get
		{
			bool valueOrDefault = cachedRemoveRoamMtb.GetValueOrDefault();
	...
	public bool AnyHediffPreventsCrawling
	{
		get
		{
			bool valueOrDefault = cachedCanCrawl.GetValueOrDefault();
