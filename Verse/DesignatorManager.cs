...
public class DesignatorManager
{
	...
	public void ProcessInputEvents()
	{
		...
		if (((int)Event.current.type == 0 && Event.current.button == 1) || KeyBindingDefOf.Cancel.KeyDownEvent)
		{
		...
		if ((int)Event.current.type == 1 && Event.current.button == 0 && (dragger.Dragging || (selectedStyle != null && selectedStyle.DrawStyleWorker.SingleCell)))
		{
