...
public static class ParseHelper
{
	...
	public static Vector2 FromStringVector2(string Str)
	{
		...
		if (array.Length == 1)
		{
			num2 = (num = Convert.ToSingle(array[0], invariantCulture));
		}
		else
		{
			if (array.Length != 2)
			...
			num2 = Convert.ToSingle(array[0], invariantCulture);
			num = Convert.ToSingle(array[1], invariantCulture);
		}
	...
	public static Vector4 FromStringVector4Adaptive(string Str)
	{
		...
		if (array.Length >= 1)
		{
			num = Convert.ToSingle(array[0], invariantCulture);
		}
		if (array.Length >= 2)
		{
			num2 = Convert.ToSingle(array[1], invariantCulture);
		}
		if (array.Length >= 3)
		{
			num3 = Convert.ToSingle(array[2], invariantCulture);
		}
		if (array.Length >= 4)
		{
			num4 = Convert.ToSingle(array[3], invariantCulture);
		}
		if (array.Length >= 5)
		{
	...
	public static Rect FromStringRect(string str)
	{
		...
		float num2 = Convert.ToSingle(array[1], invariantCulture);
		float num3 = Convert.ToSingle(array[2], invariantCulture);
		float num4 = Convert.ToSingle(array[3], invariantCulture);
