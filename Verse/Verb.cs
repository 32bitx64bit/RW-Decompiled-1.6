...
public abstract class Verb : ITargetingSource, IExposable, ILoadReferenceable
{
	...
	public virtual Texture2D UIIcon
	{
		get
		{
			...
			{
				if ((Object)(object)commandIconCached == (Object)null)
				{
	...
	{
		Texture2D icon = ((!target.IsValid) ? TexCommand.CannotShoot : ((!((Object)(object)UIIcon != (Object)(object)BaseContent.BadTex)) ? TexCommand.Attack : UIIcon));
