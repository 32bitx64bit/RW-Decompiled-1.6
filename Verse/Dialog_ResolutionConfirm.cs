...
public class Dialog_ResolutionConfirm : Window
{
	...
	public override void DoWindowContents(Rect inRect)
	{
		...
		Widgets.Label(new Rect(0f, 0f, ((Rect)(ref inRect)).width, ((Rect)(ref inRect)).height), label);
		if (Widgets.ButtonText(new Rect(0f, ((Rect)(ref inRect)).height - 35f, ((Rect)(ref inRect)).width / 2f - 20f, 35f), "ResolutionKeep".Translate()))
		{
			Close();
		}
		if (Widgets.ButtonText(new Rect(((Rect)(ref inRect)).width / 2f + 20f, ((Rect)(ref inRect)).height - 35f, ((Rect)(ref inRect)).width / 2f - 20f, 35f), "ResolutionRevert".Translate()))
		{
			Revert();
			Close();
		}
