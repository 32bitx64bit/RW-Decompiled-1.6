...
public class SectionLayer_IndoorMask : SectionLayer
{
	...
	public static void AppendQuadToMesh(LayerSubMesh mesh, float x, float z, float overage)
	{
		...
		if (mesh != null)
		{
			...
			mesh.verts.Add(new Vector3(x - overage, num, z - overage));
			mesh.verts.Add(new Vector3(x - overage, num, z + 1f + overage));
			mesh.verts.Add(new Vector3(x + 1f + overage, num, z + 1f + overage));
			mesh.verts.Add(new Vector3(x + 1f + overage, num, z - overage));
