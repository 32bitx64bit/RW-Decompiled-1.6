	...
	private void ApplyLampColor(object obj)
	{
		...
		if (obj is Building building)
		{
			...
			if (comp != null && lampsToColors.TryGetValue(building, out var value))
			{
				...
				Color.RGBToHSV(value.ToColor, ref num, ref num2, ref num3);
				float num4 = default(float);
				float num5 = default(float);
				Color.RGBToHSV(comp.GlowColor.ToColor, ref num3, ref num4, ref num5);
				comp.GlowColor = new ColorInt(Color.HSVToRGB(num, num2, num5));
			}
		}
	}
