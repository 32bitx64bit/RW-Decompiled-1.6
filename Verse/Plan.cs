...
public class Plan : IExposable, ISelectable, ILoadReferenceable, IRenameable, IHideable
{
	...
	public virtual IEnumerable<Gizmo> GetGizmos()
	{
		...
		{
			icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Designators/PlanHide"),
		...
		{
			icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Designators/PlanChangeColor"),
		...
		yield return new Command_Action
		{
			icon = (Texture)(object)TexButton.Delete,
