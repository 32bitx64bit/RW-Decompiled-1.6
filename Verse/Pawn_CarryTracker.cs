...
public class Pawn_CarryTracker : IThingHolder, IExposable
{
	...
	{
		int num = Mathf.RoundToInt(pawn.GetStatValue(StatDefOf.CarryingCapacity) / td.VolumePerUnit);
		return Mathf.Min(td.stackLimit, num);
	}
	...
	public IEnumerable<Gizmo> GetGizmos()
	{
		...
		if (pawn.Drafted && CarriedThing is Pawn)
		{
			...
			command_Action.icon = (Texture)(object)TexCommand.DropCarriedPawn;
