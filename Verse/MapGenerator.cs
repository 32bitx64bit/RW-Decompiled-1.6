...
public static class MapGenerator
{
	...
	public static void DebugDraw()
	{
		...
		{
			GenDraw.DrawLineBetween(new Vector3((float)cachedUsedRect.minX, num, (float)cachedUsedRect.minZ), new Vector3((float)cachedUsedRect.minX, num, (float)(cachedUsedRect.maxZ + 1)), SimpleColor.Red);
			GenDraw.DrawLineBetween(new Vector3((float)(cachedUsedRect.maxX + 1), num, (float)cachedUsedRect.minZ), new Vector3((float)(cachedUsedRect.maxX + 1), num, (float)(cachedUsedRect.maxZ + 1)), SimpleColor.Red);
			GenDraw.DrawLineBetween(new Vector3((float)cachedUsedRect.minX, num, (float)cachedUsedRect.minZ), new Vector3((float)(cachedUsedRect.maxX + 1), num, (float)cachedUsedRect.minZ), SimpleColor.Red);
			GenDraw.DrawLineBetween(new Vector3((float)cachedUsedRect.minX, num, (float)(cachedUsedRect.maxZ + 1)), new Vector3((float)(cachedUsedRect.maxX + 1), num, (float)(cachedUsedRect.maxZ + 1)), SimpleColor.Red);
		}
	}
