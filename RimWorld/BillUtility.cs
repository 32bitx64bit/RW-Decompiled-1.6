...
public static class BillUtility
{
	...
	public static void DoBillInfoWindow(int billIndex, string label, Rect rect, RecipeDef recipe, BodyPartRecord part = null, Pawn pawn = null)
	{
		...
		if (!recipeTooltipLayout.Empty)
		{
			...
			Rect immRect = new Rect(((Rect)(ref windowRect)).x + ((Rect)(ref rect)).xMax + 10f, ((Rect)(ref windowRect)).y + ((Rect)(ref rect)).y, recipeTooltipLayout.Size.x, recipeTooltipLayout.Size.y);
			((Rect)(ref immRect)).x = Mathf.Min(((Rect)(ref immRect)).x, (float)UI.screenWidth - ((Rect)(ref immRect)).width);
			((Rect)(ref immRect)).y = Mathf.Min(((Rect)(ref immRect)).y, (float)UI.screenHeight - ((Rect)(ref immRect)).height);
