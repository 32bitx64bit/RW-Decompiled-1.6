...
public class ScenPart_StartingAnimal : ScenPart
{
	...
	public override void DoEditInterface(Listing_ScenEdit listing)
	{
		...
		listing_Standard.ColumnWidth = ((Rect)(ref scenPartRect)).width;
	...
	{
		int level = GenCollection.MaxBy(Find.GameInitData.startingAndOptionalPawns.Take(Find.GameInitData.startingPawnCount), (Pawn c) => c.skills.GetSkill(SkillDefOf.Animals).Level).skills.GetSkill(SkillDefOf.Animals).Level;
