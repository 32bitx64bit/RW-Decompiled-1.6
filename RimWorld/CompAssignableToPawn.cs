...
public class CompAssignableToPawn : ThingComp
{
	...
	public override void DrawGUIOverlay()
	{
		...
		{
			GenMapUI.DrawThingLabel((Thing)parent, (string)"Unowned".Translate(), defaultThingLabelColor);
		}
		if (assignedPawns.Count == 1)
		{
			...
			{
				GenMapUI.DrawThingLabel((Thing)parent, assignedPawns[0].LabelShort, defaultThingLabelColor);
			}
		}
	}
	...
	public override IEnumerable<Gizmo> CompGetGizmosExtra()
	{
		if (ShouldShowAssignmentGizmo())
		{
			...
			command_Action.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/AssignOwner");
