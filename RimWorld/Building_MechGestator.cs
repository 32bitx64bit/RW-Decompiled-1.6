...
public class Building_MechGestator : Building_WorkTableAutonomous
{
	...
	protected override void DrawAt(Vector3 drawLoc, bool flip = false)
	{
		...
		Vector3 loc2 = default(Vector3);
		((Vector3)(ref loc2))._002Ector(drawLoc.x, AltitudeLayer.BuildingBelowTop.AltitudeFor(), drawLoc.z);
		cylinderGraphic.Draw(loc2, base.Rotation, this);
		Vector3 loc3 = default(Vector3);
		((Vector3)(ref loc3))._002Ector(drawLoc.x, AltitudeLayer.BuildingOnTop.AltitudeFor(), drawLoc.z);
