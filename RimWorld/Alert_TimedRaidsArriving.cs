...
public class Alert_TimedRaidsArriving : Alert
{
	...
	{
		return "AlertTimedRaidsArrivingIn".Translate(GenCollection.MinBy(timedRaidsArrivingSoon, (TimedDetectionRaids t) => t.TicksLeftToSendRaids).TicksLeftToSendRaids.ToStringTicksToPeriodVerbose());
	}
