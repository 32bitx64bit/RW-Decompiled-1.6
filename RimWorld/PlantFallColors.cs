...
public static class PlantFallColors
{
	...
	public static void SetFallShaderGlobals(Map map)
	{
		...
		{
			Shader.SetGlobalVector(FallSrc, Vector4.op_Implicit(new Vector3(FallSrcR, FallSrcG, FallSrcB)));
			Shader.SetGlobalVector(FallDst, Vector4.op_Implicit(new Vector3(FallDstR, FallDstG, FallDstB)));
			Shader.SetGlobalVector(FallRange, Vector4.op_Implicit(new Vector3(FallRangeBegin, FallRangeEnd)));
		}
	}
}
