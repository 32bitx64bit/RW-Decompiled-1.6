...
public class Building_GravEngine : Building, IRenameable
{
	...
	protected override void DrawAt(Vector3 drawLoc, bool flip = false)
	{
		...
		if (base.Spawned)
		{
			...
			((Vector3)(ref val))._002Ector(def.graphicData.drawSize.x, 1f, def.graphicData.drawSize.y);
			Graphics.DrawMesh(MeshPool.plane10Back, Matrix4x4.TRS(drawLoc, base.Rotation.AsQuat, val), OrbMat.Material, 0, (Camera)null, 0);
		}
	}
	...
	public override IEnumerable<Gizmo> GetGizmos()
	{
		...
		yield return new Command_Action
		{
			...
			icon = (Texture)(object)InspectCommandTex,
			action = delegate
			{
