...
public class Precept_Ritual : Precept
{
	...
	public virtual Texture2D CancelIcon
	{
		get
		{
			if ((Object)(object)cancelIcon == (Object)null)
			{
	...
	public static Texture2D DateRitualTex
	{
		get
		{
			if ((Object)(object)dayRitualTex == (Object)null)
			{
	...
	public static Texture2D AnytimeRitualTex
	{
		get
		{
			if ((Object)(object)anytimeRitualTex == (Object)null)
			{
	...
	public static Texture2D EventRitualTex
	{
		get
		{
			if ((Object)(object)eventRitualTex == (Object)null)
			{
	...
	public string TipExtraPart()
	{
		...
		if (ideo.Fluid)
		{
			...
			{
				float y = GenCollection.MinBy(developmentPointsOverOutcomeIndexCurveForRitual, (CurvePoint p) => p.y).y;
				float y2 = GenCollection.MaxBy(developmentPointsOverOutcomeIndexCurveForRitual, (CurvePoint p) => p.y).y;
	...
	public override void DrawIcon(Rect rect)
	{
		...
		GUI.DrawTexture(rect, (Texture)(object)Icon);
	...
	public override void DrawPreceptBox(Rect preceptBox, IdeoEditMode editMode, bool forceHighlight = false)
	{
		...
		((Rect)(ref val))._002Ector(((Rect)(ref preceptBox)).xMax - (float)DateIconSize.x, ((Rect)(ref preceptBox)).yMin, (float)DateIconSize.x, (float)DateIconSize.z);
		if (!isAnytime)
		{
			if (obligationTriggers.OfType<RitualObligationTrigger_Date>().FirstOrDefault() != null)
			{
				GUI.DrawTexture(val, (Texture)(object)DateRitualTex);
			}
			else
			{
				GUI.DrawTexture(val, (Texture)(object)EventRitualTex);
			}
		}
		else
		{
			GUI.DrawTexture(val, (Texture)(object)AnytimeRitualTex);
		}
	}
