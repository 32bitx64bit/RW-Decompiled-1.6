	...
	protected override void DoItemsLists(Rect inRect, ref float curY)
	{
		...
		if (transporter.leftToLoad != null)
		{
			for (int i = 0; i < transporter.leftToLoad.Count; i++)
			{
				...
				{
					flag = true;
					DoThingRow(t.ThingDef, t.CountToTransfer, t.things, ((Rect)(ref rect)).width, ref curY2, delegate(int x)
					{
		...
		((Rect)(ref inRect2))._002Ector((((Rect)(ref inRect)).width + 10f) / 2f, curY, (((Rect)(ref inRect)).width - 10f) / 2f, ((Rect)(ref inRect)).height);
		float curY3 = 0f;
