...
public class JobDriver_BottleFeedBaby : JobDriver_FeedBaby
{
	...
	protected override IEnumerable<Toil> MakeNewToils()
	{
		...
		{
			int num = FoodUtility.WillIngestStackCountOf(base.Baby, babyFood.def, FoodUtility.NutritionForEater(base.Baby, babyFood));
			return Mathf.Min(babyFood.stackCount, num);
