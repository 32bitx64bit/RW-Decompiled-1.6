...
public class CompApparelVerbOwner : ThingComp, IVerbOwner
{
	...
	private Command_VerbTarget CreateVerbTargetCommand(Thing gear, Verb verb)
	{
		...
		{
			command_VerbOwner.icon = (Texture)(object)verb.verbProps.defaultProjectile.uiIcon;
		...
		{
			command_VerbOwner.icon = (Texture)(object)(((Object)(object)verb.UIIcon != (Object)(object)BaseContent.BadTex) ? verb.UIIcon : gear.def.uiIcon);
