...
public abstract class QuestPart_SubquestGenerator : QuestPartActivable
{
	...
	public override void DoDebugWindowContents(Rect innerRect, ref float curY)
	{
		...
		curY += ((Rect)(ref rect2)).height + 4f;
		Rect rect3 = default(Rect);
		((Rect)(ref rect3))._002Ector(((Rect)(ref innerRect)).x, curY, 500f, 25f);
		...
		((Rect)(ref rect4))._002Ector(((Rect)(ref innerRect)).x, curY, 500f, 25f);
		if (Widgets.ButtonText(rect4, "Complete quest"))
		{
			Complete();
		}
		curY += ((Rect)(ref rect4)).height + 4f;
	}
