...
public class RitualAttachableOutcomeEffectDef : Def
{
	...
	public string AppliesToOutcomesString(RitualOutcomeEffectDef effectDef)
	{
		...
		if (onlyBestOutcome)
		{
			return GenCollection.MaxBy(effectDef.outcomeChances, (RitualOutcomePossibility o) => o.positivityIndex).label;
		}
		if (onlyWorstOutcome)
		{
			return GenCollection.MinBy(effectDef.outcomeChances, (RitualOutcomePossibility o) => o.positivityIndex).label;
		}
