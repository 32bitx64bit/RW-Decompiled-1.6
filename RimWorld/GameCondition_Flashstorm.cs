...
public class GameCondition_Flashstorm : GameCondition
{
	...
	public override void GameConditionTick()
	{
		...
		{
			Vector2 val = Rand.UnitVector2 * Rand.Range(0f, areaRadius);
			IntVec3 intVec = new IntVec3((int)Math.Round(val.x) + centerLocation.x, 0, (int)Math.Round(val.y) + centerLocation.z);
