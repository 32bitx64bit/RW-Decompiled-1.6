...
public class CompTempControl : ThingComp
{
	...
	public override IEnumerable<Gizmo> CompGetGizmosExtra()
	{
		...
		command_Action.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempLower");
		...
		command_Action2.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempLower");
		...
		command_Action3.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempReset");
		...
		command_Action4.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempRaise");
		...
		command_Action5.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempRaise");
