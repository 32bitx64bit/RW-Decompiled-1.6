...
public class QuestPart_SubquestGenerator_RelicHunt : QuestPart_SubquestGenerator
{
	...
	public override void DoDebugWindowContents(Rect innerRect, ref float curY)
	{
		...
		if (Widgets.ButtonText(new Rect(((Rect)(ref innerRect)).x, curY, 500f, 25f), "Shuffle subquest queue"))
		{
			ShuffleQueue();
		}
		curY += 29f;
		if (Widgets.ButtonText(new Rect(((Rect)(ref innerRect)).x, curY, 500f, 25f), "Log subquest queue"))
		{
