...
public abstract class CompDryadHolder : ThingComp, IThingHolder, ISuspendableThingHolder
{
	...
	private Material FrontMat
	{
		get
		{
			if ((Object)(object)cachedFrontMat == (Object)null)
			{
	...
	public override void PostDraw()
	{
		...
		if (Props.drawContents)
		{
			...
			Vector3 val2 = parent.Position.ToVector3ShiftedWithAltitude(AltitudeLayer.BuildingOnTop.AltitudeFor() + 0.01f);
			Quaternion val3 = Quaternion.Euler(0f, parent.Rotation.AsAngle, 0f);
			Vector3 val4 = default(Vector3);
			((Vector3)(ref val4))._002Ector(parent.Graphic.drawSize.x, 1f, parent.Graphic.drawSize.y);
			((Matrix4x4)(ref val)).SetTRS(val2, val3, val4);
			Graphics.DrawMesh(MeshPool.plane10, val, FrontMat, 0);
		}
	}
