...
public abstract class JobDriver_RopeToDestination : JobDriver
{
	...
	protected override IEnumerable<Toil> MakeNewToils()
	{
		...
		Toil topOfLoop3 = Toils_General.Label();
		yield return topOfLoop3;
		...
		yield return Toils_Jump.JumpIf(topOfLoop3, FindAnotherAnimalToRope);
		topOfLoop3 = Toils_General.Label();
		yield return topOfLoop3;
		...
		yield return toil;
		yield return Toils_Jump.JumpIf(topOfLoop3, UpdateDestination);
		topOfLoop3 = Toils_General.Wait(60, TargetIndex.A);
		topOfLoop3.AddPreTickIntervalAction(delegate
		{
			ProcessRopeesThatHaveArrived(roperWaitingAtDest: true);
		});
		yield return topOfLoop3;
		yield return Toils_Jump.JumpIf(topOfLoop3, () => pawn.roping.IsRopingOthers);
	}
