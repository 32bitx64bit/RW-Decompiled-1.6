...
public abstract class WorkGiver_Grower : WorkGiver_Scanner
{
	...
	public override IEnumerable<IntVec3> PotentialWorkCellsGlobal(Pawn pawn)
	{
		...
		{
			if (!(bList[j] is Building_PlantGrower building_PlantGrower) || !ExtraRequirements(building_PlantGrower, pawn) || building_PlantGrower.IsForbidden(pawn) || !pawn.CanReach(building_PlantGrower, PathEndMode.OnCell, maxDanger) || building_PlantGrower.IsBurning())
			{
				continue;
			}
