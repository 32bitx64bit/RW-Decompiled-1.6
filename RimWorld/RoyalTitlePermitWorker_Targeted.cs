...
public abstract class RoyalTitlePermitWorker_Targeted : RoyalTitlePermitWorker, ITargetingSource
{
	...
	{
		Texture2D icon = ((!target.IsValid) ? TexCommand.CannotShoot : ((!((Object)(object)UIIcon != (Object)null) || !((Object)(object)UIIcon != (Object)(object)BaseContent.BadTex)) ? TexCommand.Attack : UIIcon));
