...
public class WorkGiver_HunterHunt : WorkGiver_Scanner
{
	...
	private bool CanFindHuntingPosition(Pawn hunter, Pawn animal)
	{
		...
		newReq.maxRangeFromTarget = (animal.Downed ? Mathf.Min(newReq.verb.EffectiveRange, (float)animal.RaceProps.executionRange) : Mathf.Max(newReq.verb.EffectiveRange * 0.95f, 1.42f));
		IntVec3 dest;
