...
public static class SpaceGenUtility
{
	...
	public static void GenerateRing(Map map, CellRect rect, TerrainDef terrain, int distance, int width, float ringWidth = 4.9f, float ringExtraOffset = 0.5f, float ringExtraChance = 0f)
	{
		...
		Vector3 val = centerCell.ToVector3();
		int num = distance + width;
		Vector3 val2 = default(Vector3);
		((Vector3)(ref val2))._002Ector((float)(rect.minX - num) - ringWidth, 0f, (float)centerCell.z);
		Vector3 val3 = new Vector3((float)(rect.minX - num) - ringWidth - ringExtraOffset, 0f, (float)centerCell.z);
		Vector3 val4 = new Vector3((float)(rect.minX - num), 0f, (float)centerCell.z);
		Vector3 val5 = default(Vector3);
		((Vector3)(ref val5))._002Ector((float)(rect.minX - num) + ringExtraOffset, 0f, (float)centerCell.z);
		Vector3 val6 = val2 - val;
		float sqrMagnitude = ((Vector3)(ref val6)).sqrMagnitude;
		val6 = val4 - val;
		float sqrMagnitude2 = ((Vector3)(ref val6)).sqrMagnitude;
		val6 = val3 - val;
		float sqrMagnitude3 = ((Vector3)(ref val6)).sqrMagnitude;
		val6 = val5 - val;
		float sqrMagnitude4 = ((Vector3)(ref val6)).sqrMagnitude;
