	...
	public override IEnumerable<Gizmo> CompGetGizmosExtra()
	{
		...
		if (LoadingInProgressOrReadyToLaunch)
		{
			...
			if ((shuttle == null || !shuttle.Autoload) && innerContainer.Any)
			{
				...
				command_Action.icon = (Texture)(object)cancelLoadCommandTex;
			...
			if (Groupable)
			{
				...
				command_Action2.icon = (Texture)(object)SelectPreviousInGroupCommandTex;
				...
				command_Action3.icon = (Texture)(object)SelectAllInGroupCommandTex;
				...
				command_Action4.icon = (Texture)(object)SelectNextInGroupCommandTex;
			...
			if (Props.canChangeAssignedThingsAfterStarting && (Shuttle == null || !Shuttle.Autoload))
			{
				...
				command_LoadToTransporter.icon = (Texture)(object)LoadCommandTex;
		...
		command_LoadToTransporter2.icon = (Texture)(object)LoadCommandTex;
