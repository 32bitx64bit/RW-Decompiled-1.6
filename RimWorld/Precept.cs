...
public class Precept : IExposable, ILoadReferenceable
{
	...
	public virtual void DrawPreceptBox(Rect preceptBox, IdeoEditMode editMode, bool forceHighlight = false)
	{
		...
		((Rect)(ref rect))._002Ector(((Rect)(ref preceptBox)).x + (((Rect)(ref preceptBox)).height - 50f) / 2f, ((Rect)(ref preceptBox)).y + (((Rect)(ref preceptBox)).height - 50f) / 2f, 50f, 50f);
		DrawIcon(rect);
		Rect rect2 = new Rect(((Rect)(ref rect)).xMax + 10f, ((Rect)(ref preceptBox)).y + 3f, ((Rect)(ref preceptBox)).xMax - ((Rect)(ref rect)).xMax - 10f, ((Rect)(ref preceptBox)).height / 2f);
		...
		GUI.color = IdeoUIUtility.GetIconAndLabelColor(def.impact);
		Rect rect3 = new Rect(((Rect)(ref rect)).xMax + 10f, ((Rect)(ref preceptBox)).y + ((Rect)(ref preceptBox)).height / 2f - 3f, ((Rect)(ref preceptBox)).xMax - ((Rect)(ref rect)).xMax - 10f, ((Rect)(ref preceptBox)).height / 2f);
		Text.Anchor = (TextAnchor)3;
	...
	{
		//IL_0000: Unknown result type (might be due to invalid IL or missing references)
		GUI.DrawTexture(rect, (Texture)(object)def.issue.Icon);
	}
