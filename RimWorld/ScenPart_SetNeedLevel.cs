...
public class ScenPart_SetNeedLevel : ScenPart_PawnModifier
{
	...
	public override void DoEditInterface(Listing_ScenEdit listing)
	{
		...
		Widgets.FloatRange(new Rect(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y + ScenPart.RowHeight, ((Rect)(ref scenPartRect)).width, 31f), listing.CurHeight.GetHashCode(), ref levelRange, 0f, 1f, "ConfigurableLevel");
