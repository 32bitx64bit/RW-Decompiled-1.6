...
public class RoyalTitle : IExposable
{
	...
	private int RoomRequirementsGracePeriodTicksLeft => Mathf.Max(new int[3]
	{
		180000 - (GenTicks.TicksGame - receivedTick),
		MoveColonyUtility.TitleAndRoleRequirementGracePeriodTicksLeft,
		0
	});
