...
public class Faction : IExposable, ILoadReferenceable, ICommunicable
{
	...
	public void TryMakeInitialRelationsWith(Faction other)
	{
		...
		{
			int num = GetInitialGoodwill(this, other);
			int num2 = GetInitialGoodwill(other, this);
			int num3 = Mathf.Min(num, num2);
			FactionRelationKind kind = ((num3 > -10) ? ((num3 < 75) ? FactionRelationKind.Neutral : FactionRelationKind.Ally) : FactionRelationKind.Hostile);
			...
			factionRelation2.baseGoodwill = num3;
