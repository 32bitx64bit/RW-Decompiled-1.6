...
public class MinifiedTree : MinifiedThing, IThingHolderTickable, IThingHolder
{
	...
	public override Graphic Graphic
	{
		get
		{
			...
			if (cachedGraphic == null)
			{
				...
				((Vector2)(ref newDrawSize))._002Ector(minifiedDrawSize.x / (float)base.InnerThing.def.size.x * cachedGraphic.drawSize.x, minifiedDrawSize.y / (float)base.InnerThing.def.size.z * cachedGraphic.drawSize.y);
