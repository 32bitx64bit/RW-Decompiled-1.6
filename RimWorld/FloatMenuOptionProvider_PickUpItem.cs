...
public class FloatMenuOptionProvider_PickUpItem : FloatMenuOptionProvider
{
	...
	public override IEnumerable<FloatMenuOption> GetOptionsFor(Thing clickedThing, FloatMenuContext context)
	{
		...
		{
			int num = Mathf.Min(MassUtility.CountToPickUpUntilOverEncumbered(context.FirstSelectedPawn, clickedThing), clickedThing.stackCount);
			int to = Mathf.Min(maxAllowedToPickUp, num);
