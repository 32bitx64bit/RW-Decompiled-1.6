...
public class Comp_AtmosphericHeater : CompTempControl, IThingGlower
{
	...
	public override IEnumerable<Gizmo> CompGetGizmosExtra()
	{
		...
		command_GroupedTempChange.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempLower");
		...
		command_GroupedTempChange2.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempLower");
		...
		command_Action.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempReset");
		...
		command_GroupedTempChange3.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempRaise");
		...
		command_GroupedTempChange4.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/TempRaise");
