...
public class Building_BioferriteHarvester : Building
{
	...
	public override IEnumerable<Gizmo> GetGizmos()
	{
		...
		command_Toggle.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/BioferriteUnloading");
		...
		if (containedBioferrite >= 1f)
		{
			...
			command_Action.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/EjectBioferrite");
