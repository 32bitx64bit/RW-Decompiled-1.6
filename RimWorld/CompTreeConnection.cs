...
public class CompTreeConnection : ThingComp
{
	...
	private Material PodMat
	{
		get
		{
			if ((Object)(object)cachedPodMat == (Object)null)
			{
	...
	public override IEnumerable<Gizmo> CompGetGizmosExtra()
	{
		if (Connected)
		{
			...
			command_Action.icon = (Texture)(object)((Mode == null) ? ContentFinder<Texture2D>.Get("UI/Gizmos/UpgradeDryads") : Widgets.GetIconFor(Mode.pawnKindDef.race));
	...
	public override void PostDraw()
	{
		...
		if (dryads.Count < MaxDryads)
		{
			...
			Vector3 val2 = parent.Position.ToVector3ShiftedWithAltitude(AltitudeLayer.BuildingOnTop.AltitudeFor()) + Props.spawningPodOffset;
			...
			((Matrix4x4)(ref val)).SetTRS(val2, Quaternion.identity, new Vector3(num, 1f, num));
			Graphics.DrawMesh(MeshPool.plane10, val, PodMat, 0);
		}
	}
