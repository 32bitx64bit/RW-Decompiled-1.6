...
public class CompStudiable : ThingComp
{
	...
	public virtual float AnomalyKnowledge
	{
		get
		{
			...
			{
				Debug.LogError((object)$"Thing {parent} has studiable comp but has no overriden anomaly knowledge amount, ensure this is on a pawn with setup race props vars, or provides a knowledge amount value in this comp.");
			}
	...
	public override IEnumerable<Gizmo> CompGetGizmosExtra()
	{
		...
		if (Props.showToggleGizmo && (flag || reason != null))
		{
			Command_Toggle command_Toggle = new Command_Toggle
			{
				...
				icon = (Texture)(object)StudyToggleIcon.Texture,
