...
{
	public static Texture2D SlaveSuppressionFillTex = SolidColorMaterials.NewSolidColorTexture(Color32.op_Implicit(new Color32((byte)245, (byte)209, (byte)66, byte.MaxValue)));
	...
	public static Texture2D SlaveIcon
	{
		get
		{
			if ((Object)(object)slaveIcon == (Object)null)
			{
