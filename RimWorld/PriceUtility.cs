...
public static class PriceUtility
{
	...
	public static float PawnQualityPriceFactor(Pawn pawn, StringBuilder explanation = null)
	{
		...
		for (int i = 0; i < allDefsListForReading.Count; i++)
		{
			...
			float num2 = PawnCapacityUtility.CalculateCapacityLevel(pawn.health.hediffSet, allDefsListForReading[i], null, forTradePrice: true);
			num *= Mathf.Lerp(0.5f, 1f, num2);
		}
		if (pawn.skills != null)
		{
